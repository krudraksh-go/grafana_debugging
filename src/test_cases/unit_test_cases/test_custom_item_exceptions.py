...
from custom_item_exceptions import custom_item_exceptions
...
class Test_custom_item_exception_with_sector(TestSetupDBDag):
    ...
    def method_to_mock_query(*args,**kwargs):
        if 'select *  from item_picked where' in args[0]:
            return ResultSet({})
            ...
            data = [{'name': 'item_picked',
                    ...
                    'values': [['2023-11-28T08:00:25.561527486Z','59744867','butler_demo','Sector5','Item']]}]
            ...
            data = [{'name': 'item_exception',
                    ...
                    'values': [['2023-11-28T07:49:09.157014Z','2','tsgvm02363','butler_demo','true','737826','pick','59781472','37','1','12818','12818.0.B.05-B.06','missing',1]]}]
            return ResultSet({'series': data})
    ...
    def test_custom_item_exceptions_with_sector(self,mock_get_tenant_info,mock_is_influx_reachable,mock_get_start_date,mock_query,mock_writepoints):
        ...
        with DAG(
            ...
            PythonOperator(
                ...
                python_callable=functools.partial(custom_item_exceptions().custom_item_exceptions,
