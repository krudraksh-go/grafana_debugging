...
from custom_orderline_transactions_sector import custom_Orderline_transactions_sector
...
class Test_custom_item_exception_with_sector(TestSetupDBDag):
    ...
    def test_custom_orderline_transactions_sector(self,mock_get_tenant_info,mock_is_influx_reachable,mock_get_start_date,mock_query,mock_writepoints):
        ...
        with DAG(
                ...
                description='custom_Orderline_transactions_sector',
                catchup=False,
                schedule=None,
        ) as dag:
            import functools
            ...
            PythonOperator(
                ...
                python_callable=functools.partial(custom_Orderline_transactions_sector().custom_Orderline_transactions_sector,
        ...
        ti = dagrun.get_task_instance(task_id='custom_Orderline_transactions_sector_final')
        ti.task = dag.get_task(task_id='custom_Orderline_transactions_sector_final')
